...
c6_df_rec %>% 
  ...
  geom_col(width = .7) +
  coord_flip() +
  labs(x = NULL, title = "Guidance on how to comply with the policies by the financing entities that require OA to publications")
```
...
![](02_exploration_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](02_exploration_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
```r
d2_df_rec %>% 
  plot_likert(question_codes, "Drivers and barriers to practicing Open Science")
```

![](02_exploration_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
![](02_exploration_files/figure-html/unnamed-chunk-9-1.png)<!-- -->

# D7 Drivers or barriers to practice Open Science


```r
answer_levels_9 <- c("Don’t know/ Don’t have enough information", "Neither barrier nor driver", "Barrier",
                     "Driver")
...
![](02_exploration_files/figure-html/unnamed-chunk-10-1.png)<!-- -->
